 ...
 *
 * 🚨 **この注記は「書いただけ」です。古くなっても鳴りません**（司令塔 2026-08-16 の区別）。
 *   古くなる条件はただ1つ: **この API を呼ぶ画面が 1 つでもできた瞬間**。
 *   そのとき上の「画面は 0 件 ／ SSO は実質使えません」は**嘘になります**が、
 *   **検査は落ちず、出力にも何も出ません。** 画面を作る人が、ここも一緒に消してください。
 *   （鳴る形にしていない理由: 画面の鍵が 282 の結論で変わるため、
 *     いま見張りを書くと**見張りのほうを作り直す**ことになる。**判断であって、忘れではない。**）
 * ─────────────────────────────────────────────────────────────
 */
