      ...
      <div data-slot="surface-container" className="@container/surface w-full min-w-0">
        <section
          ...
          className={cn(
            ...
            // 1箇所直せば全ページに効く。
            //
            // 🟢 **2026-08-16 実測: 効いていることを確かめた**（design）。
            //    sp 390 / ja / /admin/collections/<c> … 面が **3 つ・隣接 2 組**
            //      どちらも **上の下線 0px / 下の上線 1px / 間隔 24px** ＝ **線は 1 本**
            //    🚨 その前に「隣接する面が 0 件なので、効いているか確かめられない」と
            //    書きかけた。**見ていた 5 画面に隣接が無かっただけ**で、
            //    Surface を 2 つ以上置く画面は **5 ファイル**在った。
            //    ＝ **「まだ出番が来ていない 0」ではなく「探す場所を間違えた 0」だった。**
